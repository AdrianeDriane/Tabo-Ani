  ...
  return (
    <section className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
      ...
      <div className="flex gap-3">
        <button className="px-6 py-3 bg-agri-green text-white rounded-2xl font-semibold text-sm hover:bg-opacity-90 transition-all shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)]">
          New Purchase Order
        </button>
      </div>
    </section>
