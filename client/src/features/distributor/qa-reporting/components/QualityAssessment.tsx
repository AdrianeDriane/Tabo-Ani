          ...
          <div className="flex gap-2">
            {gradeOptions.map((option) => (
              <button
                ...
                className={
                  grade === option.value
                    ? "flex-1 py-2 border-2 border-agri-leaf bg-agri-leaf/10 text-agri-green font-bold text-sm rounded-lg"
                    : "flex-1 py-2 border-2 border-gray-200 text-gray-400 font-bold text-sm rounded-lg hover:border-agri-leaf/50"
                }
                type="button"
